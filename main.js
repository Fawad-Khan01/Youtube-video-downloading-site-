...
function show_model(kdata,title,ext,note){
    ...
    try {
        ...
        if ( open_ads == "1" &&  false) {
            ...
            $("#A_downloadUrl").attr("href", "https://s.ssstiktok.ws/?url=" + kdata.downloadUrlX + "&ref=" + window.location.href );
...
function showDownloadErrorModal(errorMsg){
    $("#loading_img").css('display', 'none');
    $("#result-wait").css('display', 'none');
    $("#downloadErrorLabel").html("Online download service error, You can try again or use <a href='https://iflydown.com/?aaa-yt5sbiz'>iflydown video downloader</a> to download.")
